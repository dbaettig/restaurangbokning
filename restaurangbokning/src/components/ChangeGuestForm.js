            ...
            <div className="wrapper">
                <div className="formWrapper">
                    <form className="dateForm">
                        ...
                        <input type="text" name="firstName" value={this.props.state.firstName} onChange={this.props.handleChange} /><br />
						...
						<br />
                        <button className="reservationsButton" type="submit" value="submit" onClick={this.props.changeGuest}>Change</button>
                        <button className="reservationsButton" onClick={this.props.closeChangeGuestForm}>Cancel</button>
                    </form>
                </div>
            </div>
        )
